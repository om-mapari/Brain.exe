...
![[1-7-2. 🌐 Networking (Container Communication).png|Bridge Network]]

![[2-7-2. 🌐 Networking (Container Communication).png|Network Communication]]

![[3-7-2. 🌐 Networking (Container Communication).png|Container DNS]]

Docker has built-in DNS server that help container to resolve each other with the name of the container.

![[4-7-2. 🌐 Networking (Container Communication).png|DNS Resolution]]
