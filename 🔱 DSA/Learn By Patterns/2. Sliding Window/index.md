...
| 2. [Problem Challenge 1: Permutation in a String (medium)](https://leetcode.com/problems/permutation-in-string/)               | 📍👀 | Is one string a permutation of another?<br>just compare frequencies, <br>don’t need to generate all permutations. |                     |
| 3. [Problem Challenge 2: String Anagrams (medium)](https://leetcode.com/problems/find-all-anagrams-in-a-string/)               | ⭐    |                                                                                                                   |                     |
| 4. [Problem Challenge 4: Words Concatenation (hard)](https://leetcode.com/problems/substring-with-concatenation-of-all-words/) | 📍👀 |                                                                                                                   |                     |
