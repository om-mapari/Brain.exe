...
- [[1. Amazon RDS]] - Relational Database Service fundamentals
- [[2. Amazon RDS Read Replicas]] - RDS scaling and high availability
- [[9. IAM Roles & Policies]] - Identity and Access Management
...
4. **Deep Dive**: [[1. Amazon RDS]], [[2. Amazon RDS Read Replicas]], [[9. IAM Roles & Policies]]
...
- [[0. EC2 Index]] - Virtual machines, instance types, pricing
...
- [[9. EBS and EFS Storage]] - Block storage
- [[9. EBS and EFS Storage]] - File storage
- S3 - Object storage
...
- [[2. Amazon RDS Read Replicas]] - RDS scaling
...
- [[0. VPC Index]] - Virtual Private Cloud
- [[5. Security Groups]] - Instance firewalls
- [[6. Network ACLs]] - Subnet firewalls
- [[1. Application Load Balancer]] - Layer 7 load balancing
- [[2. Network Load Balancer]] - Layer 4 load balancing
- Route 53 - DNS service
- CloudFront - CDN

### Security

- [[9. IAM Roles & Policies]] - Access management
...
- [[8. AWS Architecture Design]] - AWS architecture patterns
...
- [[5. AWS Kinesis]] - Real-time data streaming
- [[4. AWS DataSync]] - Data transfer service
- SQS - Message queuing
...
- [[0. VPC Index]] - Networking foundation
- [[0. EC2 Index]] - Compute foundation
- [[0. ECS Index]] - Containers

### Architecture

- [[0. Soluation Architect Questions]] - Design patterns
- [[1. Load Balancing Algorithms]] - LB strategies
- [[2. Inter-Process Communication (IPC)]] - Inter-process communication
- [[2. Infrastructure as Code (IaaC)]] - Automation

### Additional Services

- [[0. AWS Services Index]] - CloudFormation, Kinesis, etc.

### Practical Skills

- Linux - System administration
- [[0. Internet and Networking Overview]] - Fundamentals
