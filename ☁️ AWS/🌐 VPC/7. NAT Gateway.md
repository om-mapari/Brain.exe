...
|-----------------|----------------|
| ![NAT Gateway Single AZ](../../../images/aws/vpc/nat-gateway-1.png) | ![NAT Gateway Multi AZ](../../../images/aws/vpc/nat-gateway-2.png) |

| If AZs goes downs then NAT goes down | Recommended for Production workloads |
|--------------------------------------|--------------------------------------|
| ![AZ Failure](../../../images/aws/vpc/nat-gateway-3.png) | Launch multiple NAT per AZs ![Multi NAT](../../../images/aws/vpc/nat-gateway-4.png) |
